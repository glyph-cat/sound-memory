 ...
 * other.
 */
export function createFlowController<T>() {
...
// dynamic type <T> can be shared. Also, this is the global flow controller.
// Only create another flow controllers if you don't want to have anything to
// separate it from any sort of global interference.
export const flow: <T>(
  flowKey: string,
  asyncCallback: () => Promise<T>
